...
#    Decompile APK
    ...
    Ctrl+F: https://animalcompany.us-east1.nakamacloud.io

    Replace with: Your hosted backend url if self hosting
...
# Rebrand Package Name
    ...
    Change: woosterGames.animalCompany
...
# Fix Gamedata
    ...
    In the backend there is still xeras link (that is down) so change that to yours (link: https://xeracompany.pythonanywhere.com/game-data-prod.zip)
